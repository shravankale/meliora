...
class PerfTestDriver:
    ...
    def __init__(self, tinfo, use_parallel_search, language="c", timing_code=''):
        ...
        #Meliora Driver
        self.tinfo.post_build_cmd = 'python3 /home/users/shravank/projects/meliora2/Meliora/scripts/meliora_driver.py'
    ...
    def __build(self, perf_params=None, coord=None):
        ...
        #Meliora Driver insertion

        if self.tinfo.post_build_cmd:

            #Meliora postbuild command
